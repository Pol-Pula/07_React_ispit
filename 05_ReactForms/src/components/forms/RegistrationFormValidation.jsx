...
//   function handleChange(event) {
//   const { name, value, type, checked } = event.target;
//   const trenutnaVrijednost = type === "checkbox" ? checked : value;

//   // 1. Ažuriramo podatke forme
//   setFormData((prev) => ({
//     ...prev,
//     [name]: trenutnaVrijednost,
//   }));

//   // 2. Odmah pokrećemo validaciju za to jedno specifično polje i ažuriramo errors stanje
//   const porukaGreske = validateField(name, trenutnaVrijednost);
